...
//	private TextFlow errMeasuredValue;
	...
	**********************************************************************************************/
	...
	public UserInterface(Pane theRoot) {
		...
		setupLabelUI(label_errOperand1, "Arial", 14, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 10, 125);
...
//		setupTextUI()
		...
		setupLabelUI(label_errOperand2, "Arial", 14, Calculator.WINDOW_WIDTH-10, Pos.BASELINE_LEFT, 10, 250); // changed this to accommodate the error message within the UI.
...
//		errMeasuredValue.setLayoutY(100);
		...
		theRoot.getChildren().addAll(label_IntegerCalculator, label_Operand1, text_Operand1, label_errOperand1, 
				...
				button_Add, button_Sub, button_Mpy, button_Div,button_sqrt);//added button_square root for sqare_root button
...
//		System.out.println(performGo());
		...
		if (perform.setOperand1(text_Operand1.getText())) {	// Set the operand and see if there was an error
		    ...
		    label_errOperand1.setText(performGo().toString());
	}
	...
	private void setOperand2() {
		...
		if (perform.setOperand2(text_Operand2.getText())) {
			...
			label_errOperand2.setText(performGo_2().toString());
	}
...
//		performGo();
	...
	private String performGo() 
	{
		...
		if (errMessage != "") {
			...
			if (MeasuredValueRecognizer.measuredValueIndexofError <= -1) return errMessage;
